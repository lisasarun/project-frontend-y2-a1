      ...
      <div className="bg-white rounded-[2.5rem] border border-slate-200 shadow-xl overflow-hidden">
        ...
        <div className="p-10">
          ...
          <div className="prose max-w-none">
            ...
            <div className="bg-slate-50 rounded-3xl p-8 border text-slate-700">
              {lessonSummary || "No content available."}
            </div>
          </div>
          ...
          {pdfUrl && (
            <div className="mt-8">
              ...
              <iframe
                src={pdfUrl}
                className="w-full h-[600px] rounded-2xl border shadow"
              />
            </div>
          )}
          ...
          <div className="mt-12 pt-10 border-t">
            ...
            {!showQuiz ? (
              <div className="bg-indigo-50 rounded-[2rem] p-8 flex justify-between items-center">
                <div>
                ...
                <button
                  onClick={() => setShowQuiz(true)}
                  className="px-8 py-4 bg-indigo-600 text-white rounded-2xl"
                >
                  Start Quiz
                </button>
              </div>
            ) : (
              <div className="border-2 border-indigo-600 p-8 rounded-[2rem]">
                <QuizModule />
